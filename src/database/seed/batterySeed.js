...
const batteries = [
    {
      ...
      voltage: 12,
      price: 200,
      description: "AGM deep cycle battery with long lifespan and maintenance-free design.",
    },
    {
      name: "LiFePO4 200Ah",
      ...
      voltage: 24,
      price: 800,
      description: "Lithium iron phosphate battery with high efficiency and deep discharge capability.",
    },
    {
      ...
      voltage: 12,
      price: 180,
      description: "Traditional lead-acid battery requiring maintenance but affordable and reliable.",
    },
    {
      ...
      voltage: 48,
      price: 1200,
      description: "Extremely durable battery with a lifespan of 30+ years, ideal for off-grid systems.",
    },
    {
      ...
      voltage: 24,
      price: 600,
      description: "Compact lithium battery with high energy density and fast charging capability.",
    },
  ];
